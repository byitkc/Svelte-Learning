...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 5, 0, 63);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 4, 0, 53);
    			button1.disabled = button1_disabled_value = /*chosenOption*/ ctx[0] === 2;
    			add_location(button1, file, 7, 0, 151);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	function custominput_value_binding(value) {
    		/*custominput_value_binding*/ ctx[2](value);
    	}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [value, selectedOption, custominput_value_binding, toggle_chosenOption_binding];
    }

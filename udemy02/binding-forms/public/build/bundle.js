...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 8, 0, 99);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	function custominput_value_binding(value) {
    		/*custominput_value_binding*/ ctx[13](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 49, 0, 1342);
    			add_location(br0, file, 50, 0, 1385);
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file, 52, 4, 1402);
    			add_location(div0, file, 51, 0, 1392);
    			add_location(h1, file, 57, 4, 1488);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "name", "color");
    			input2.__value = "red";
    			input2.value = input2.__value;
    			add_location(input2, file, 59, 8, 1532);
    			add_location(label0, file, 58, 4, 1516);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "name", "color");
    			input3.__value = "green";
    			input3.value = input3.__value;
    			add_location(input3, file, 68, 8, 1708);
    			add_location(label1, file, 67, 4, 1692);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "name", "color");
    			input4.__value = "blue";
    			input4.value = input4.__value;
    			add_location(input4, file, 77, 8, 1888);
    			add_location(label2, file, 76, 4, 1872);
    			add_location(div1, file, 56, 0, 1478);
    			add_location(br1, file, 86, 0, 2053);
    			option0.__value = "green";
    			option0.value = option0.__value;
    			add_location(option0, file, 89, 8, 2120);
    			option1.__value = "red";
    			option1.value = option1.__value;
    			add_location(option1, file, 90, 8, 2165);
    			option2.__value = "blue";
    			option2.value = option2.__value;
    			add_location(option2, file, 91, 8, 2206);
    			if (/*singleFavoriteColor*/ ctx[5] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[22].call(select));
    			add_location(select, file, 88, 4, 2070);
    			add_location(div2, file, 87, 0, 2060);
    			add_location(br2, file, 94, 0, 2262);
    			attr_dev(input5, "type", "text");
    			add_location(input5, file, 98, 4, 2396);
    			add_location(button0, file, 99, 4, 2448);
    			add_location(div3, file, 95, 0, 2269);
    			add_location(br3, file, 101, 0, 2497);
    			add_location(div4, file, 102, 0, 2504);
    			add_location(br4, file, 103, 0, 2532);
    			attr_dev(input6, "type", "email");
    			attr_dev(input6, "class", input6_class_value = "" + (null_to_empty(isValidEmail(/*enteredEmail*/ ctx[7]) ? "" : "invalid") + " svelte-t0g050"));
    			add_location(input6, file, 106, 8, 2589);
    			attr_dev(button1, "type", "submit");
    			button1.disabled = button1_disabled_value = !/*formIsValid*/ ctx[10];
    			add_location(button1, file, 111, 8, 2742);
    			add_location(form, file, 105, 4, 2549);
    			add_location(div5, file, 104, 0, 2539);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*singleFavoriteColor*/ 32) {
    				select_option(select, /*singleFavoriteColor*/ ctx[5]);
    			}

    			if (!current || dirty & /*enteredEmail*/ 128 && input6_class_value !== (input6_class_value = "" + (null_to_empty(isValidEmail(/*enteredEmail*/ ctx[7]) ? "" : "invalid") + " svelte-t0g050"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function select_change_handler() {
    		singleFavoriteColor = select_value(this);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*singleFavoriteColor*/ 32) {
